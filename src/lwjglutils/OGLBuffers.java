...
public class OGLBuffers {
	...
	protected class VertexBuffer {
		...
		public String toString() {
			...
			text.append("VertexBuffer ID: ").append(id).append(", stride: ").append(stride).append(", length: ").append(attributes.length);
			for (int i = 0; i< attributes.length; i++ ){
				text.append("\n\t\t").append(i).append(": ").append(attributes[i].toString());
			}
	...
	public void addVertexBuffer(float[] data, Attrib[] attributes) {
		...
		for (Attrib attribute : attributes) floatsPerVertex += attribute.dimension;
	...
	public String toString() {
		StringBuilder text = new StringBuilder();
		text.append("OGLBuffers" + ", indexCount: ").append(indexCount).append(", vertexCount: ").append(vertexCount);
		for (VertexBuffer vb: vertexBuffers){
			text.append("\n\t").append(vb.toString());
		}
		return text.toString();
