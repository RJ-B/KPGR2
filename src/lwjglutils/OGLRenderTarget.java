...
public class OGLRenderTarget {
	...
	public String toString() {
		...
		text.append("OGLRenderTarget: " + "[").append(getWidth()).append("x").append(getHeight()).append("] \n");
		text.append("	depth buffer: ").append(getDepthTexture().toString());
		for (int i= 0; i<colorBuffers.length; i++){
			text.append("	").append(i).append(". color buffer: ").append(getColorTexture(i).toString());
			}
